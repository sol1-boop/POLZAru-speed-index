    ...
    def calculate_stats(values):
        if values:
            ...
            return {
                ...
                'percentile_75': round(statistics.quantiles(values, n=100)[74], 2) if len(values) >= 2 else None,
                'percentile_95': round(statistics.quantiles(values, n=100)[94], 2) if len(values) >= 2 else None,
